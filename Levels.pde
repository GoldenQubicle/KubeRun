class Levels {
  ...
  ArrayList Targetsetup() {
    ...
    if (state.level == 3) {
            ...
            TargetColor = color(255, 255, 51, 64);
      //                 size, R, xpos,             ypos,      trigger,    distance,             color, score, last, curves
      ...
      T3 = new Target(150, 3, random(300, 550), random(150, 405), random(300, 400), random(1250, 1500), 1000, false, 45);
      T4 = new Target(100, 2, random(150, 450), random(320, 590), random(550, 650), random(900, 1000),1000, false, 75);
      T5 = new Target(640, 6, 320, 320, 700, 7500, 1800, true, 0);
      Targets.add(T1);
      Targets.add(T2);
      Targets.add(T3);
      Targets.add(T4);
  ...
  void generator() {
    ...
    if (state.level == 3) {
      ...
      if(T2.sight == true){
      Cubes lvl3 = new Cubes(35, 70, -700, -150, ColorKube, color(0, 0, 255), color (100, 100, 100), 100);    
      Kubes.add(lvl3);
      TargetEmission =  color (255,0,0);
      ...
      if (T3.sight == true) {
        ...
        //ColorKube = color(R, B);
        //ColorKube = ColorWall;
        Cubes lvl3S = new Cubes(20, 35, 0, 50, ColorWall, color (0, 0, 255), ColorWall_M_E, 150); 
        Kubes.add(lvl3S);
